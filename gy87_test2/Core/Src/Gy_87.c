...
uint8_t MPU_Basic_Init(I2C_HandleTypeDef *I2Cx)
{
	...
	//Init HMC5883L
	HAL_I2C_Mem_Read(&hi2c1, HMC5883L_ADDRESS, HMC5883L_IDA, 1, &res, 1, DELAY_I2C);
	if (res == 0x48)
	{
		HAL_I2C_Mem_Read(&hi2c1, HMC5883L_ADDRESS, HMC5883L_IDB, 1, &res, 1, DELAY_I2C);
	}
	else
		return 2;
	...
	if (res == 0x34)
	{
		HAL_I2C_Mem_Read(&hi2c1, HMC5883L_ADDRESS, HMC5883L_IDC, 1, &res, 1, DELAY_I2C);
	}
	else
		return 3;
